...
const RecentComments = ({
  ...
  if (count === 0) {
    return (
      <div className="rounded-3xl border border-white/40 bg-gradient-to-br from-white/80 via-white/70 to-white/60 p-8 shadow-lg backdrop-blur-xl dark:border-gray-700/40 dark:from-gray-900/80 dark:via-gray-800/70 dark:to-gray-900/60">
