  ...
  return (
    <div className="mb-8 flex items-center justify-between">
      ...
      <Link
        ...
        className="group/link flex items-center gap-2 rounded-xl bg-blue-100/60 px-4 py-2 text-sm font-semibold text-blue-700 shadow-md transition-all duration-200 hover:scale-105 hover:bg-blue-200/60 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-800/40"
      >
        View all
