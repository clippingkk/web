...
async function Footer() {
  ...
  return (
    <footer className="relative border-t border-slate-800/20 bg-slate-900">
      {/* Background layers */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        {/* Glow effects */}
        <div className="absolute -bottom-20 left-1/2 h-60 w-full max-w-5xl -translate-x-1/2 rounded-full bg-blue-500/5 opacity-60 blur-3xl"></div>
        <div className="absolute top-10 right-10 h-40 w-40 rounded-full bg-cyan-500/5 opacity-50 blur-3xl"></div>
        <div className="absolute bottom-40 left-20 h-32 w-32 rounded-full bg-blue-500/5 opacity-40 blur-3xl"></div>

        {/* Subtle gradient lines */}
        <div className="absolute top-0 right-0 left-0 h-px bg-gradient-to-r from-transparent via-blue-500/10 to-transparent"></div>
      </div>

      {/* Content overlay */}
      <div className="relative z-10 mx-auto max-w-7xl backdrop-blur-sm">
            ...
            <div className="space-y-4">
              ...
              {version && (
                <div className="flex items-center gap-1.5 text-xs text-slate-500">
                  <code className="rounded bg-slate-800/50 px-2 py-0.5 font-mono">
                    {version}
                  </code>
                </div>
              )}
        ...
        <div className="relative mt-4 border-t border-slate-800/20 py-8">
          <div className="text-center text-xs text-slate-500">
            <span className="relative">
              <span className="absolute -inset-1 bg-gradient-to-r from-transparent via-blue-500/10 to-transparent opacity-0 blur-sm transition-opacity duration-1000 group-hover:opacity-100"></span>
              {t(
                'footer.madeWithLove',
