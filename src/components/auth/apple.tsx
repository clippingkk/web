...
function AuthAppleButton(props: Props) {
  ...
  return (
    <button
      className="group relative h-16 w-full rounded-xl border border-gray-200 bg-white px-6 shadow-sm transition-all duration-200 hover:scale-[1.02] hover:shadow-md disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100 dark:border-zinc-700 dark:bg-black"
      onClick={onClick}
    >
