    ...
    return (
      <div className="mt-2 flex justify-center py-8">
        <button
          type="button"
          onClick={onLoadMore}
          className="rounded-xl border border-blue-200/60 bg-white/70 px-5 py-2 text-sm font-medium text-blue-500 shadow-sm backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-600 focus:ring-2 focus:ring-blue-400 focus:outline-none motion-reduce:transition-none motion-reduce:hover:translate-y-0 dark:border-blue-400/30 dark:bg-slate-800/60 dark:text-blue-300 dark:hover:border-blue-400/60 dark:hover:bg-blue-400/10"
        >
          {t('app.clippings.loadMore')}
        </button>
      </div>
    )
  }
