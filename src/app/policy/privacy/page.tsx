...
function PrivacyPolicy() {
  ...
  return (
    <section className='page p-20'>
      ...
      <p>
        ClippingKK ("us", "we", or "our") operates the website and the
        ClippingKK mobile application (the "Service").
      </p>
      ...
      <p>ClippingKK uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside China and choose to provide information to
        us, please note that we transfer the data, including Personal Data, to
        China and process it there.
      </p>
      <p>
      ...
      <p>
        ClippingKK will take all steps reasonably necessary to ensure that your
      ...
      <p>
        ClippingKK may disclose your Personal Data in the good faith belief that
        such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of ClippingKK</li>
        <li>
