    ...
    <div className='relative min-h-screen w-full overflow-hidden bg-slate-900'>
      ...
      <div className='relative z-10 flex h-screen w-full flex-col items-center justify-center px-4'>
        <div className='w-full max-w-md overflow-hidden rounded-2xl bg-white/5 p-8 backdrop-blur-lg'>
          ...
          <div className='mt-4 mb-8 rounded-lg border border-red-400/20 bg-red-400/5 p-4 text-center text-sm backdrop-blur-sm'>
          ...
          <div className='flex flex-col gap-3'>
            <button
              onClick={() => reset()}
              className='group relative overflow-hidden rounded-lg bg-[#045fab] px-4 py-3 text-center font-medium text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#045fab]/30 active:translate-y-0'
            >
