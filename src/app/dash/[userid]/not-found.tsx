...
async function UserNotFound() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 md:p-8">
      <div className="relative max-w-xl w-full bg-gradient-to-br from-red-500/10 to-purple-500/10 rounded-2xl overflow-hidden backdrop-blur-xl border border-gray-100/20 dark:border-gray-800/30 p-8 md:p-12">
