...
import { type Clipping, type User } from '@/schema/generated'
  ...
  return (
    <div className="flex gap-4">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="overflow-hidden rounded-xl border border-gray-200 bg-white transition-all duration-200 focus-within:border-blue-400 focus-within:shadow-sm focus-within:shadow-blue-400/20 dark:border-zinc-700 dark:bg-zinc-800 dark:focus-within:border-blue-400">
          <CKBaseEditor
            editable
        ...
        <div className="mt-3 flex items-center justify-between gap-3" ref={ref}>
          ...
          <Button
            variant="primary"
            className="bg-blue-400 text-white shadow-sm transition-all duration-200 hover:bg-blue-500 hover:shadow-md dark:bg-blue-400 dark:hover:bg-blue-500"
            isLoading={loading}
