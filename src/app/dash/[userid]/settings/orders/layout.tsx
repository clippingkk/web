...
async function SettingsOrdersLayout({ children }: { children: React.ReactNode }) {
      ...
      <div className='mb-8 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm border border-gray-100 dark:border-gray-700 shadow-sm'>
        <div className='flex flex-col items-center text-center'>
          ...
          <p className='text-gray-600 dark:text-gray-400 max-w-lg'>
            {t('app.settings.orders.description', 'Review your past purchases and subscription history. Manage your payment information and view receipts.')}
          </p>
        </div>
      </div>
